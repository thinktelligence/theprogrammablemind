...
let configStruct = {
  ...
  */
  ...
  priorities: [
    ...
    [['list', 1], ['between', 0], ],
    [['between', 1], ['is', 0], ],
    [['hierarchyAble', 0], ['is', 0], ],
    [['hierarchyAble', 0], ['a', 0], ['is', 0], ],
    [['does', 0], ['have', 1], ],
    [['doesnt', 0], ['does', 0], ['have', 0], ],
    [['not', 0], ['is', 0], ['propertyOf', 0], ],
    [['objectPrefix', 0], ['is', 0], ['questionMark', 0], ],
    [['possession', 0], ['is', 0], ['questionMark', 0], ],
    [['possession', 1], ['is', 0], ['questionMark', 0], ],
    [['a', 0], ['have', 0], ],
    [['have', 0], ['does', 0], ],
    [['what', 0], ['is', 0], ['possession', 0], ['propertyOf', 0], ],
    [['possession', 1], ['is', 0], ],
    [['objectPrefix', 0], ['is', 0], ],
    [['property', 0], ['is', 0], ['what', 0], ['propertyOf', 0], ['articlePOS', 0], ],
    [['propertyOf', 1], ['is', 0], ],
    [['articlePOS', 0], ['propertyOf', 0], ],
    [['property', 0], ['articlePOS', 0], ['propertyOf', 0], ],
    [['have', 0], ['questionMark', 0], ],
    [['have', 0], ['questionMark', 0], ['have', 1], ['is', 1], ],
    [['what', 0], ['is', 0], ['objectPrefix', 0], ],
  ],
  generators: [
    {
