...
const config = {
  ...
  bridges: [
    ...
    { 
      ...
      localHierarchy: [['unknown', 'theAble']],
      level: 0, 
      // bridge: "{ ...after[0], pullFromContext: false, instance: false, concept: true, number: 'one', wantsValue: true, determiner: operator, modifiers: append(['determiner'], after[0].modifiers) }" 
