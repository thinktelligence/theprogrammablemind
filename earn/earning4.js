...
let config = {
  operators: [
    ...
    '(([query]) [does] (([personConcept]) [earn2|earn]))'
  ],
  bridges: [
    { "id": "earn2", "level": 0, "bridge": "{ ...operator, who: before[0].id }" },
    { "id": "does", "level": 0, "bridge": "{ marker: 'earn', who: after[0].who, units: 'dollars', isQuery: true, what: before}" },
...
//const query = 'joe earns 10 dollars every week joe worked 15 weeks joe earns what'
const query = 'joe earns 10 dollars every week joe worked 15 weeks what does joe earn'
//const query = 'joe earns what'
